...
# Load your CSV
file_path = "C:\\Users\\Rahel\\Desktop\\KAIM 5&6\\Week2\\Customer-Experience-Analytics-for-Fintech-App\\data\\sentiment\\thematic_analysis\\distilbert_reviews_with_themes.csv"
...
plt.figure(figsize=(10, 6))
sns.countplot(data=df, x="identified_themes", hue="distilbert_sentiment")
